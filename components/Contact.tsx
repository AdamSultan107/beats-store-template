            ...
            <Card className="bg-neutral-50">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">business@shadx2.com</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">Collaborations</h4>
                  <p className="text-gray-600">collab@shadx2.com</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-1">Support</h4>
                  <p className="text-gray-600">support@shadx2.com</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-neutral-50">
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <Button
                    variant="outline"
                    className="justify-start h-12 border text-black hover:text-pink border-neutral-300 text-black hover:bg-neutral-200"
                  >
